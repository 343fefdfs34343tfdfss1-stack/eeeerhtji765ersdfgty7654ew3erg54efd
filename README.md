...
Run `/remove user` to open a compact, paginated removal list. Each line shows the Roblox avatar, username, user ID, and a hyperlink to the profile. Choose a user from the dropdown, then press **Remove** or **Cancel**.
